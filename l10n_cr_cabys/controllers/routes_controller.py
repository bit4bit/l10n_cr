    ...
    def index(self, vat):
        ...
        if url_base:
            ...
            if peticion.status_code in (200, 202) and len(peticion._content) > 0:
                ...
                http.request.env.cr.execute("UPDATE res_company SET ultima_respuesta='%s' WHERE id=%s" % (
                    ultimo_mensaje, company_id.id))
                ...
                if 'nombre' in contenido:
                    ...
                    if 'identification_id' in res_partner:
                        ...
                        if 'tipoIdentificacion' in contenido:
                            ...
                            if clasificacion == '01':  # Cedula Fisicaclasificacion
                                identification_id = id_type.search(
                                    [('code', '=', '01')], limit=1).id
                    ...
                    if contenido.get('nombre') != None:
                        ...
                        retorno = {"nombre": str(
                            name), "identification_id": str(identification_id)}
