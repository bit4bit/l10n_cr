...
class ResConfigSettings(models.TransientModel):
    ...
    load_lines = fields.Boolean(
        string=_(
            'Indicates if invoice lines should be load when loading a Costa Rican Digital Invoice'),
        default=True
    )
    ...
    def get_values(self):
        ...
        res.update(
            ...
            expense_analytic_account_id=int(
    ...
    def set_values(self):
        ...
        set_param('expense_analytic_account_id',
                  self.expense_analytic_account_id.id)
