...
class CompanyElectronic(models.Model):
    ...
    frm_ws_identificador = fields.Char(
        string="Electronic invoice user", required=False)
    
    frm_ws_password = fields.Char(
        string="Electronic invoice password", required=False)
    ...
    frm_ws_ambiente = fields.Selection(selection=[('disabled', 'Deshabilitado'),
                                       ...
                                       required=True,
                                       default='disabled',
                                       help="Es el ambiente en al cual se le está actualizando el"
                                       " certificado. Para el ambiente de calidad (stag), para el "
                                       " ambiente de producción(prod). Requerido.")
